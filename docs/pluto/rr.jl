...
# ╔═╡ c4fd65b6-fdad-421d-9f29-bee3adaf925c
using ZipFile, DataFrames, Downloads, CSV, CategoricalArrays

# ╔═╡ 6807f3c0-aa36-11ec-03fc-29ebe8385366
md"""

# Reproducing Rust & Rothwell (1995)

"""

# ╔═╡ 61f8d704-c51f-4705-951d-1744b4fcf553
md"""
# Data 
...
# ╔═╡ 5b67e221-e2a7-4f6f-9ce8-23283b14d4dd
md"""
First, we donwload the zip archive.
"""

# ╔═╡ f820f435-b42a-49ae-9d56-26f1a88a98ae
datazip = let 
...
# ╔═╡ 04541357-8972-456a-823f-ed53e513f421
md"""
Now, we read the time invariant information.
"""

# ╔═╡ d9b2d66f-43fd-459d-bb73-54b118338a66
nukesum = let 
...
# ╔═╡ 4acdf7c7-9fa3-4fbc-8554-d9d1b5c67350
md"And the time-varying information."

# ╔═╡ 589992f8-15de-4ca3-ad75-aae181c63038
nuket = let 
	zfr = ZipFile.Reader(datazip)
...
# ╔═╡ a5a47b6d-08da-4a2d-849d-1b9f9246c817
describe(nuket)

# ╔═╡ 3ec993cc-f50c-41ea-80f6-59d5c0142292
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "e1a9c4eeffc5add0d091d7226b462059cc44f3cd"
